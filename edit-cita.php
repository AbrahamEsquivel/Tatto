<?php
    ...
    if (!isset($_GET['id']) || !filter_var($_GET['id'], FILTER_VALIDATE_INT)) {
        ...
        include 'admin_footer.php'; // Cerramos la página
        exit;
    }
...
<style>
    .form-container { 
        max-width: 800px; 
        margin: 0 auto; /* Centrado dentro del admin-content */
        background: #fff; 
        padding: 2rem; 
        border-radius: 10px; 
    ...
    .form-container .btn { width: 100%; padding: 10px; background: #3B82F6; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; }
...
<div class="form-container">
    <form id="form-editar-cita" action="php/updateCita.php" method="POST">
        ...
        <a href="pago-form.php?id_cita=<?php echo $cita['id_cita']; ?>" class="btn btn-verde" style="margin-top: 10px; text-align: center;">
